...
Zur Ansteuerung des LCD wird idealerweise eine Rechteckspannung von \(-3\,\textrm{V}\) bis \(3\,\textrm{V}\) bei einer Frequenz von \(50\,\textrm{Hz}\) im Mulitplexverfahren.
...
Das Platinenlayout wurde mit der kostenlosen Version von Eagle erstellt. Anschließend wurde die komplette Platine im FAUFabLab gefertigt. Eine Anleitung hierzu befindet sich auf der Homepage des \cite[FAUFabLab]{fablabwerkzeuge}, weshalb hier nicht näher darauf eingegangen wird.
