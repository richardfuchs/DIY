...
Die Stromstärken haben wir mit einem Multimeter gemessen. Im Ruhezustand hat das Messgerät bereits einen Strom von -2uA 
%FIXME uA -> micrometer
...
%FIXME 0815 wirklich schreiben?

\subsubsection{Herstellung der Platine}
{\b Sicherheitshinweis:} 
%FIXME nur S wird unterstrichen
